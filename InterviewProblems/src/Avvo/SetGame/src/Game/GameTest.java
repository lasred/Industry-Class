...
public class GameTest {
	...
	public void testSetInBoard() {
		SetCard[] testSequenceSetInBoard = {ph, c1, ph, ph, c2, ph, ifSet};
		List<SetCard> boardHasSet = Arrays.asList(testSequenceSetInBoard);
		Set<SetCard> set = Game.getSetInBoard(boardHasSet);
	...
	public void testNoSetInBoard() {
		...
		Set<SetCard> noSet = Game.getSetInBoard(boardHasNoSet);
		assertNull(noSet);
	}
}
